...
PGRE.FORMULAS = [
  ...
  },
  {
    ...
    back: "All about symmetry axis through CM unless noted:\n\n| Geometry | Axis | Moment of Inertia $I$ |\n| :--- | :--- | :--- |\n| **Thin hoop / ring** (or point mass, radius $R$) | Central symmetry axis | $I = MR^2$ |\n| **Solid disk / cylinder** (radius $R$) | Central symmetry axis | $I = \\frac{1}{2}MR^2$ |\n| **Thin spherical shell** (radius $R$) | Any diameter (through CM) | $I = \\frac{2}{3}MR^2$ |\n| **Solid sphere** (radius $R$) | Any diameter (through CM) | $I = \\frac{2}{5}MR^2$ |\n| **Thin rod through center** (length $L$) | Axis $\\perp$ rod through center | $I = \\frac{1}{12}ML^2$ |\n| **Thin rod through end** (length $L$) | Axis $\\perp$ rod through one end | $I = \\frac{1}{3}ML^2$ |",
