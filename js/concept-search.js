...
(function () {
  ...
  var TEACH_RULES = [
    { id: 'theta', match: /\b(?:unit\s+vector\s+)?theta\b/i, len: 17 },
    { id: 'theta', match: /\bfrom\s+z\b/i, len: 10 },
    { id: 'phi', match: /\bfrom\s+x\b/i, len: 10 },
    { id: 'theta', match: /\bcolatitudes?\b/i, len: 10 },
    { id: 'phi', match: /\bdirection\s+of\s+azimuth\b/i, len: 20 },
    { id: 'phi', match: /\bazimuth(?:al)?\s+direction\b/i, len: 17 },
    { id: 'phi', match: /\bazimuth(?:al)?s?\b/i, len: 8 },
    { id: 'bField', match: /\b(?:b[\s_-]*field|magnetic(?:\s+field)?|induction)\b/i, len: 14 },
    { id: 'current', match: /\b(?:current|amperian|wire)\b/i, len: 8 },
    { id: 'rho', match: /\b(?:wire\s*dist(?:ance)?|perpendicular(?:\s*dist(?:ance)?)?)\b/i, len: 14 },
    { id: 'rho', match: /\brhos?\b/i, len: 4 },
    { id: 'rho', match: /\\rho\b/i, len: 5 },
    { id: 'rho', match: /[ρ]/, len: 2 },
    { id: 'basis', match: /\b(?:unit\s+vectors?|basis(?:\s+vectors?)?)\b/i, len: 12 },
    { id: 'spherical', match: /\bspherical\b/i, len: 9 },
    { id: 'cylindrical', match: /\bcylindrical\b/i, len: 11 },
    { id: 'phi', match: /\bphi\s*hat\b/i, len: 7 },
    { id: 'phi', match: /\bhat\s*phi\b/i, len: 7 },
    { id: 'phi', match: /\\hat\{\\phi\}|\\hat\{\\varphi\}/i, len: 12 },
    { id: 'phi', match: /\bamp[eè]re\b/i, len: 6 },
    { id: 'phi', match: /\bparallels?\b/i, len: 8 },
    { id: 'phi', match: /\blatitudes?\b/i, len: 8 },
