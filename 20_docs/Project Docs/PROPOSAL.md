...
*Written July 15, 2026 · exam November 1, 2026 · **status: ALL 15 ITEMS SHIPPED July 15, 2026** (see `DESIGN.md` §8 for where each landed). The "considered and ruled out" list below remains ruled out.*
