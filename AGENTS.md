...
- `docs/`: Project documentation (`Project Docs/` for specs/proposals/design) and gitignored exam/book PDFs (`ETS Released Exams/`, `Conquering the Physics GRE.../`).
...
- **Specs & Proposals:** Place design documents, RFCs, and proposals in `docs/Project Docs/`.
- **Copyrighted Materials:** Store all original and derived exam/book content exclusively in gitignored paths under `docs/` and `content/`.
